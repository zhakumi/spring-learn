 ...
 *
 * @Component注解的类，会生成ScannedGenericBeanDefinition类型的Bean定义。
 * 注意其它继承了@Component的注解如@Service、@Controller、
 * @Repository也是生成ScannedGenericBeanDefinition类型的Bean定义
 *
 * spring扫描后生成的BeanDefinition
 */
